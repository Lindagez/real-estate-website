...
CREATE TABLE `property`(
    ...
    `noBedroom` INT NOT NULL DEFAULT 'not defined',
    `noBathroom` INT NOT NULL DEFAULT 'not defined',
        `noGarage` INT NOT NULL DEFAULT 'not defined',
    `totalSize` INT NOT NULL DEFAULT 'not defined',
    `livingroomSize` INT NOT NULL DEFAULT 'not defined',
    `bedroomSize` INT NOT NULL DEFAULT 'not defined',
    `bathroomSize` INT NOT NULL DEFAULT 'not defined',
    `garageSize` INT NOT NULL DEFAULT 'not defined',
    `buildYear` INT NOT NULL DEFAULT 'not defined',
    `createdAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    `updatedAt` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
